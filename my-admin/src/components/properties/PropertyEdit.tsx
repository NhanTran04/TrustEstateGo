...
import { BooleanInput, DateTimeInput, Edit, FileInput, FormTab, ImageField, minLength, minValue, NumberInput, RecordContextProvider, ReferenceInput, required, SelectInput, TabbedForm, TextInput } from "react-admin";
