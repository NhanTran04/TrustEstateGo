...
## Features
- Secure user authentication with **OAuth2 and JWT**
- Role-based access control with **Spring Security**
- Online payment subscriptions with **PayPal**
...
## Technologies
- **Backend**: Spring Boot, Spring Security, Spring Data JPA, RESTful APIs  
- **Frontend**: React Admin (TypeScript), ReactJS  
- **Database**: MySQL  
